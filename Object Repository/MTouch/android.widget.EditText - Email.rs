...
<MobileElementEntity>
   ...
   <locator>new UiSelector().className(&quot;android.widget.EditText&quot;).text(&quot;Email&quot;).resourceId(&quot;&quot;).packageName(&quot;com.atf.ecommercelive_merchant&quot;).enabled(true).clickable(true).longClickable(false).checkable(false).checked(false).focusable(true).focused(false).scrollable(false).selected(false).index(3)</locator>
